...
class AjahIbeju extends StatefulWidget {
  const AjahIbeju({Key? key}) : super(key: key);

  @override
  State<AjahIbeju> createState() => _AjahIbejuState();
}

class _AjahIbejuState extends State<AjahIbeju> {
  int i = 1;
