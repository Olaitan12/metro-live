...
class Festac extends StatefulWidget {
  const Festac({Key? key}) : super(key: key);

  @override
  State<Festac> createState() => _FestacState();
}

class _FestacState extends State<Festac> {
  int i = 1;

  int dataPrice = 4500;
  int dataPricePromo = 4500;
