...
class AyoboAjasa extends StatefulWidget {
  const AyoboAjasa({Key? key}) : super(key: key);

  @override
  State<AyoboAjasa> createState() => _AyoboAjasaState();
}

class _AyoboAjasaState extends State<AyoboAjasa> {
  int i = 1;

  int dataPrice = 2500;
  int dataPricePromo = 2500;
