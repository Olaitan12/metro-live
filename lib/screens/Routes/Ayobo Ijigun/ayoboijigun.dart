...
class AyoboIjigun extends StatefulWidget {
  const AyoboIjigun({Key? key}) : super(key: key);

  @override
  State<AyoboIjigun> createState() => _AyoboIjigunState();
}

class _AyoboIjigunState extends State<AyoboIjigun> {
  int i = 1;

  int dataPrice = 3500;
  int dataPricePromo = 3500;
