...
class AgbaraTotowu extends StatefulWidget {
  const AgbaraTotowu({Key? key}) : super(key: key);

  @override
  State<AgbaraTotowu> createState() => _AgbaraTotowuState();
}

class _AgbaraTotowuState extends State<AgbaraTotowu> {
  int i = 1;

  int dataPrice = 3800;
  int dataPricePromo = 3800;
  ...
  void _clickSuperBesar() {
    setState(() {
      ...
      pricePromo = (dataPricePromo + 3800) * i;
      isMini = false;
      isSedang = false;
      isBesar = false;
      isSuperBesar = true;
