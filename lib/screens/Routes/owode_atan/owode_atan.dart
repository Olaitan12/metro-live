...
class OwodeAtan extends StatefulWidget {
  const OwodeAtan({Key? key}) : super(key: key);

  @override
  State<OwodeAtan> createState() => _OwodeAtanState();
}

class _OwodeAtanState extends State<OwodeAtan> {
  int i = 1;
